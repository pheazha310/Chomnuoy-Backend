...
<body>
    <main class="page">
        ...
        <footer class="footer">
            ...
            <span>Laravel <?php echo e(app()->version()); ?> | PHP <?php echo e(PHP_VERSION); ?></span>
        </footer>
    </main>
</body>
</html>
<?php /**PATH C:\Users\SOPHEA.PHAL\Desktop\Chomnuoy-Backend\resources\views/welcome.blade.php ENDPATH**/ ?>